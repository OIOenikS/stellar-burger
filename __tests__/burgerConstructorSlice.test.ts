...
describe("tests for burgerConstructor slice", () => {
    ...
    describe("tests reducer for add ingredient in burgerConstructor", () => {
        test("test add filling in burgerConstructor", () => {
            ...
            const newState = burgerConstructorReducers(initialBurgerConstructorState, addIngredientInConstructor({
                calories: 420,
                carbohydrates: 33,
                fat: 244,
    ...
    test("test reducer for delete ingredient from constructor", () => {
        ...
        const newState = burgerConstructorReducers(initialBurgerConstructorState, deleteIngredientFromConstructor("fbd334ab-f1f6-42bd-8dde-41fb38d77c79"));
        const { constructorItems } = newState;
    ...
    test("test reducer for move forward ingredient", () => {
        const initialBurgerConstructorState = mockInitialBurgerConstructorState;
        const newState = burgerConstructorReducers(initialBurgerConstructorState, moveForwardIngredient(1));
        const { constructorItems } = newState;
    ...
    test("test reducer for move back ingredient", () => {
        const initialBurgerConstructorState = mockInitialBurgerConstructorState;
        const newState = burgerConstructorReducers(initialBurgerConstructorState, moveBackIngredient(1));
        const { constructorItems } = newState;
    ...
    test("test reset constructor items", () => {
        const initialBurgerConstructorState = mockInitialBurgerConstructorState;
        const newState = burgerConstructorReducers(initialBurgerConstructorState, resetConstructorItems());
        const { constructorItems } = newState;
        expect(constructorItems).toEqual({
            bun: null,
            ingredients: []
